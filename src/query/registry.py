...
FLOW_NET = registry.register(FieldSpec("flow_net", "净流入", "flow", ("flow",)))
NORTH = registry.register(FieldSpec("northbound", "北向资金", "flow", ()))
PB = registry.register(FieldSpec("pb", "市净率", "quote", ("quote",)))
...
OFF_LOW = registry.register(FieldSpec("off_low", "离底%", "bottom", ("quote", "bars")))
MULTIPLE = registry.register(FieldSpec("multiple", "顶底倍", "bottom", ("quote", "bars")))
TARGET = registry.register(FieldSpec("target", "目标卖价", "bottom", ("quote", "bars")))
